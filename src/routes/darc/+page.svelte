...
<section class="section section-alt">
  <div class="container">
    <div class="text-center" style="margin-bottom: 3rem;">
      ...
      <p style="max-width: 640px; margin: 0 auto;">
        Darc runs on macOS, Windows, and Linux. Choose your platform to get started.
      </p>
    </div>
        ...
        <div class="screenshot-container">
          ...
          <div class="os-icon-overlay">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d={operatingSystems[currentOS].icon}/>
            </svg>
          </div>
...
<section class="section">
  <div class="container text-center">
    ...
    <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
      <a href="/" class="btn btn-primary btn-compact">
